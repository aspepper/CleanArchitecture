...
{
    public class ListUserHandle(IUserService userService, ILogger<UserEventHandle> logger, IMediator mediator) : IRequestHandler<ListUserQuery, GenericQueryResult>
    {
