    ...
    where TEvent : ISagaEvent
{
        ...
        where TCompensateEvent : ISagaEvent, new()
    {
        ISagaPublishActivity<TSagaData, TEventToSend, TCompensateEvent> publishActivity = (ISagaPublishActivity<TSagaData, TEventToSend, TCompensateEvent>)builderState.ServiceProvider.
            GetService(typeof(ISagaPublishActivity<TSagaData, TEventToSend, TCompensateEvent>)) ?? new SagaStepForPublishActivity<TSagaData, TEventToSend, TCompensateEvent>();
        ...
        builderState.Model.FindActionForStateAndEvent(builderState.CurrentState, builderState.CurrentEvent).ChildSteps.AddStep(publishActivity);
        ...
        where TEventToSend : ISagaEvent, new()
    {
        ISagaPublishActivity<TSagaData, TEventToSend, EmptyEvent> publishActivity = (ISagaPublishActivity<TSagaData, TEventToSend, EmptyEvent>)builderState.ServiceProvider.
            GetService(typeof(ISagaPublishActivity<TSagaData, TEventToSend, EmptyEvent>)) ?? new SagaStepForPublishActivity<TSagaData, TEventToSend, EmptyEvent>();
        ...
        where TEventHandler : ISagaEventHandler<TSagaData, TEvent>
    {
        ...
        ISagaAction action = builderState.Model.FindActionByStateAndEventType(builderState.CurrentState, builderState.CurrentEvent);
        ...
        Action<ISagaBuilderThen<TSagaData, TEvent>> builderAction)
    {
        ...
        mainChildAction.ChildSteps.RemoveEmptyStepsAtBeginning();
        parentStep.SetChildSteps(mainChildAction.ChildSteps);
        currentAction.ChildSteps.AddStep(parentStep);
